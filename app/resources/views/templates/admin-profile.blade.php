                                    ...
                                    <div class="col-4">
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item">
                                                <strong>Role:</strong> {{ $user->roleName ?? 'Not available' }}
                                            </li>
                                            <li class="list-group-item">
                                                <strong>Phone:</strong> {{ $user->phone_number ?? 'Not available' }}
                                            </li>
                                            <li class="list-group-item">
                                        ...
                                        <form action="{{ route('update.admin.profile') }}" method="POST"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <input type="text" name="name" id="location" class="form-control"
                                                        value="{{ $user->names ?? '' }}">
                                                </div>
                                                <div class="col-6">
                                                    ...
                                                    <input type="text" name="phone" id="location" maxlength="10"
                                                        class="form-control"
                                                        value="{{ $user->phone_number ?? '07xxxxxxxx' }}">
                                                </div>
                                                <div class="col-6 mt-3">
                                                    <label for="" class="form-label">Address
                                                    </label>
                                                    <input type="text" name="address" id="address" class="form-control"
                                                        value="{{ $user->address ?? 'xxxxxxxx' }}">
                                                </div>
                                                <div class="col-6 mt-3">
                                                    <label for="" class="form-label">Email
                                                    </label>
                                                    <input type="email" name="email" id="email" class="form-control"
                                                        value="{{ $user->email ?? 'xxxxxxxx@gmail.com' }}">
                                                </div>
                                                <div class="col-12 mt-3">
                                                    <label for="" class="form-label">Password
                                                    </label>
                                                    <input type="password" name="password" id="password"
                                                        class="form-control" placeholder="enter new password password"
                                                        disabled>
                                                </div>
                                                <div class="col-6 mt-3">
